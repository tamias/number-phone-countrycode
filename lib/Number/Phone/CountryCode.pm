...
my %Codes = (
    ...
    AO => ['244',   '00',    '0'], # Angola
    AQ => ['672',  undef,  undef], # Antarctica (Australian bases in)
    ...
    CD => ['243',   '00',    '0'], # Congo, The Democratic Republic of the
    ...
    CU => [ '53',  '119',    '0'], # Cuba
    CV => ['238',   '00',  undef], # Cape Verde Islands
    ...
    KR => [ '82',  '001',    '0'], # Korea, Republic of
    KW => ['965',   '00',    '0'], # Kuwait
    KY => [  '1',  '011',    '1'], # Cayman Islands
    KZ => [  '7',  '810',    '8'], # Kazakhstan (IDD really 8**10)
    LA => ['856',   '00',    '0'], # Lao People's Democratic Republic
    LB => ['961',   '00',    '0'], # Lebanon
    ...
    SR => ['597',   '00',    '0'], # Suriname
    ST => ['239',   '00',    '0'], # Sao Tome and Principe
    SV => ['503',   '00',  undef], # El Salvador
    SY => ['963',   '00',    '0'], # Syrian Arab Republic
    SZ => ['268',   '00',  undef], # Swaziland
    TC => [  '1',    '0',    '1'], # Turks and Caicos Islands
